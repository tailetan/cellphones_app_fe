  ...
  render() {
    return (
      <div>
        ...
        <h5 className="m-b-4 m-t-4 font-weight-bold">Thống kế sản phẩm bán được của Cellphones</h5>
        <AdminBarChart />
        <h5 className="m-b-4 m-t-4 font-weight-bold">Thống kế hóa đơn của Cellphones</h5>
        <AdminLineChart />
      </div>
    );
  }
