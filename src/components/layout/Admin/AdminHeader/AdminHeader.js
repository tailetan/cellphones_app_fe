...
import { AppBar, Box, Button, Drawer, Menu, MenuItem, Toolbar } from '@mui/material';
    ...
    <div>
      <AppBar
        ...
        <Toolbar>
          <Box sx={{ flexGrow: 1 }}>
            <div className="logo">
              <a href="https://cellphones.com.vn/" title="CellphoneS - Hệ thống bán lẻ điện thoại">
            ...
            <ul className="d-flex">
              <li className="m-r-5">
                <a
                  ...
                  className={`font-weight-bold p-x-4 p-y-2 ${
                    pathName === '/admin/dashboard' ? ' bg-white text-red br-8px' : ' text-white'
                  }`}>
                  Dashboard
                </a>
              </li>
              <li className="m-r-5">
                <a
                  href="/admin/products"
                  className={`font-weight-bold p-x-4 p-y-2 ${
                    pathName === '/admin/products' ? ' bg-white text-red br-8px' : ' text-white'
                  }`}>
                  Sản phẩm
                </a>
              </li>
              <li className="m-r-5">
                <a
                  href="/admin/bills"
                  className={`font-weight-bold p-x-4 p-y-2 ${
                    pathName === '/admin/bills' ? ' bg-white text-red br-8px' : ' text-white'
                  }`}>
                  Hóa đơn
                </a>
              </li>
              <li>
                <a
                  href="/admin/users"
                  className={`font-weight-bold p-x-4 p-y-2 ${
                    pathName === '/admin/users' ? ' bg-white text-red br-8px' : ' text-white'
                  }`}>
                  Người dùng
                </a>
              </li>
      ...
      {pathName !== '/admin/dashboard' && (
        <Drawer
          ...
          sx={{
            width: drawerWidth,
            flexShrink: 0,
            [`& .MuiDrawer-paper`]: { width: drawerWidth, boxSizing: 'border-box', zIndex: 1199 }
          }}>
          <Toolbar />
