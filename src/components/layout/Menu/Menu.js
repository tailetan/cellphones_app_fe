...
function Menu({ menu }) {
  const goToShop = (name) => {
    ...
    if (name === 'Laptop, PC, Màn hình') window.location.href = '/shop?category=laptop';
  ...
  const goToShopWithBrand = (name, brand) => {
    if (name === 'Điện thoại') window.location.href = `/shop?category=mobile&brand=${brand}`;
    if (name === 'Laptop, PC, Màn hình')
      window.location.href = `/shop?category=laptop&brand=${brand}`;
    if (name === 'Tablet') window.location.href = `/shop?category=tablet&brand=${brand}`;
    if (name === 'Phụ kiện') window.location.href = `/shop?category=accessory&brand=${brand}`;
  };
        ...
        {menu.map((i, index) => (
          <li
            ...
            className={`ml-content d-flex align-center ${
              ['Điện thoại', 'Tablet', 'Phụ kiện', 'Laptop, PC, Màn hình'].includes(i.name)
                ? 'text-black'
                : 'text-gray'
            }`}>
            <a
              ...
              onClick={() => {
                if (['Điện thoại', 'Tablet', 'Phụ kiện', 'Laptop, PC, Màn hình'].includes(i.name)) {
                  goToShop(i.name);
                }
              }}>
                      ...
                      i.brand.map((itemChild, indexChild) => (
                        <li
                          ...
                          <a
                            ...
                            {itemChild.icon ? (
                              <i className={`mlc-icon-left ${itemChild.icon}`} />
                            ) : (
                              ''
                            )}
                          ...
                          <div className="box-list-menu-child-2">
                            <nav className="menu">
                              <ul className="menu-layout p-l-0">
                                {itemChild.brand &&
                                  itemChild.brand.map((itemChild2, indexChild2) => (
                                    <li
                                      key={indexChild2}
                                      className={`ml-content text-gray ${
                                        itemChild2.brand ? 'ml-content-child-2' : ''
                                      } d-flex align-center`}>
                                      <a className="w-full d-flex align-center">
                                        {itemChild2.icon ? (
                                          <i className={`mlc-icon-left ${itemChild2.icon}`} />
                                        ) : (
                                          ''
                                        )}
                                        <span className="mlc-name flex-1 font-weight-bold">
                                        ...
                                        {itemChild2.brand || itemChild2.child ? (
                                      ...
                                      <div className="box-list-menu-child-3">
                                        <nav className="menu">
                                          <ul className="menu-layout p-l-0">
                                            {itemChild2.brand &&
                                              itemChild2.brand.map((itemChild3, indexChild3) => (
                                                <li
                                                  key={indexChild3}
                                                  className="ml-content d-flex align-center">
                                                  <a className="w-full d-flex align-center">
                                                    ...
                                                    {itemChild3.brand || itemChild3.child ? (
                                                      <span className="material-icons-round">
                                                        navigate_next
                                                      </span>
                                                    ) : (
