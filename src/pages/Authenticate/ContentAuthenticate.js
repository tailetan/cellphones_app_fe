...
function ContentAuthenticate() {
  return (
    <div>
      <p>
        Từ ngày 01/10/2021,{" "}
        <span className="font-weight-bold text-red">CellphoneS</span> sẽ chính
        thức áp dụng chính sách Smember 2.0 với nhiều ưu đãi hấp dẫn, cụ thể như
        sau:
      </p>
      <br />
      <table
      ...
      <p>
        <i>
          (*) Giá trị hoá đơn sau khi đã trừ các KM, CT giảm giá khác, không áp
          dụng với nhóm sản phẩm dịch vụ (BHMR, sim, thẻ, thu hộ,...)
        </i>
      </p>
      <br />
      <p>
        <i>
          Code <span className="font-weight-bold">SINH NHẬT</span> sẽ được áp
          dụng đối với hóa đơn mua hàng có giá trị{" "}
          <span className="font-weight-bold">GẤP ĐÔI</span> giá trị của code
          khuyến mãi.
        </i>
      </p>
      <br />
      ...
      <p>
        ...
        nhật (áp dụng 1 lần/năm và có hạn sử dụng 1 tháng theo cấp ưu đãi trên),
        ngoài ra, tùy theo từng chương trình khuyến mại cho thành viên, Smember
        sẽ nhận được mã giảm giá{" "}
        <u>
      ...
      <p>
        ...
        được tính bằng doanh thu tích luỹ trong 12 tháng gần nhất (thay vì tích
        luỹ trọn đời)
      </p>
      <br />
