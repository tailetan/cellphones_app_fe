      ...
      <div className="a-content">
        <ul>
          ...
          <li className="d-flex align-items-center m-b-2">
            ...
            <span className="m-l-4">Giảm thêm 5% tối đa 1 triệu khi thanh toán qua Kredivo</span>
          </li>
          <li className="d-flex align-items-center m-b-2">
            <img src={Image2} alt="Logo 2" width="40" />
            <span className="m-l-4">Mở thẻ tín dụng Citibank - Nhận e-voucher tới 2 triệu</span>
          </li>
          <li className="d-flex align-items-center m-b-2">
            <img src={Image5} alt="Logo 5" width="40" />
            <span className="m-l-4">Mở thẻ tín dụng TPBank EVO - Nhận ưu đãi đến 6.6 triệu</span>
          </li>
          <li className="d-flex align-items-center m-b-2">
            <img src={Image3} alt="Logo 3" width="40" />
            <span className="m-l-4">
              Nhập QRCPS giảm đến 300.000đ áp dụng các đơn hàng từ 4 triệu trở lên khi thanh toán
              qua VNPAY tại cửa hàng
            </span>
          </li>
          <li className="d-flex align-items-center m-b-2">
